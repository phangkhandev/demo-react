...
const ListQA2 = (props) => {
    ...
    return (
        <div>
            <p style={{ color: "red", textAlign: "center", marginTop: "10px" }}>Đề thi A2 gồm 25 câu thời gian làm bài 19 phút số câu đúng tối thiểu là 23/25</p>

            <div className="list-quiz-container container">
                {arrQuiz && arrQuiz.length > 0 &&
                    arrQuiz.sort((a, b) => a.id - b.id).map((quiz, index) => {
                        if (quiz.id > 78 && quiz.id < 97) {
                            return (
