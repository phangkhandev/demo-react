        ...
        <div className='quiz-container'>
            ...
            <Accordion defaultActiveKey="0">
                ...
                <Accordion.Item eventKey="1">
                    <Accordion.Header><span style={{ fontSize: "27px", fontWeight: "600" }}>Update Q/A Quiz</span></Accordion.Header>
                    <Accordion.Body>
                        <QuizQA />
                    </Accordion.Body>
                </Accordion.Item>
                <Accordion.Item eventKey="2">
                    <Accordion.Header><span style={{ fontSize: "27px", fontWeight: "600" }}>Assign to Users</span></Accordion.Header>
                    <Accordion.Body>
                        <AssignQuiz />
                    </Accordion.Body>
                </Accordion.Item>
